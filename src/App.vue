...
//   something.value = await (await fetch(`https://api.waifu.im/search?included_tags=maid&height=%3E=2000`, {
//     method: 'GET',
//     mode: 'cors',
//   })).json();
// }
...
<template>
  ...
  <div class="min-h-screen flex flex-col dark:bg-#131130">
      ...
      <main class="main pt-4vh lt-lg:pt-4vh pb-8vh flex-grow-1">
        ...
        <div>
          <div class="rounded-md shadow-box p-2 max-h-[600px] max-w-[800px] overflow-auto dark:text-neutral-400">
            <pre><code>
              {{content}}
